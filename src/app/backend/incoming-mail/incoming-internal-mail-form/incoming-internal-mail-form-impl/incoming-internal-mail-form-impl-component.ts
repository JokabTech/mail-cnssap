...
@Component({
  ...
  templateUrl: './incoming-internal-mail-form-impl-component.html',
  styleUrl: './incoming-internal-mail-form-impl-component.scss',
  providers: [
    { provide: TINYMCE_SCRIPT_SRC, useValue: 'tinymce/tinymce.min.js' },
    provideNativeDateAdapter()
  ]
})
export class IncomingInternalMailFormImplComponent {
  ...
  onDisplayOnlinePdf() {
    this.pdfService.displayOnlinePdf(this.mail.id, 'document', 'incoming-internal-mails');
  }
  ...
  onSearchUser() {
    ...
    dialogRef.afterClosed().subscribe((user: User) => {
      this.form.get('sender_id')?.setValue(user.id);
    });
  }
}
