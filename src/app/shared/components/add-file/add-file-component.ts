...
export class AddFileComponent {
  ...
  readonly data: { title: string, id: number, subject: string, endpoint: string } = inject(MAT_DIALOG_DATA);
  ...
  sendFile() {
    ...
    this.http.sendFormData(JSON.stringify({ id: this.data.id }), this.pdfService.localPdf, 'post').subscribe({
      next: (event) => {
