...
export class IncomingExternalMailImplFormComponent implements OnInit, OnDestroy {
  ...
  onDisplayOnlinePdf() {
    this.pdfService.displayOnlinePdf(this.formActionPayload.data.id, 'document', 'incoming-external-mails');
  }
